...
### Observações: 
- Não foram apresentados, em detalhes, os exemplos de possíveis aplicações de
  refatorações no projeto do grupo. As possíveis aplicações das refatorações
  foram apenas brevemente indicadas textualmente. 
